...
practices to debug failing code, rather friction caused by the ~pure~ attribute should highlight code
design flaws, helping guide development of code that is debuggable and testable.
